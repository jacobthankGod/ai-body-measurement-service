...
class EmailService:
    ...
    async def send_scan_request_email(
        ...
        _ATTIRE_DISPLAY = {
            ...
            'tuxedo': 'Tuxedo (Black Tie Formal)',
            'denim': 'Denim (Classic Casual)',
            'streetwear': 'Streetwear (Urban Oversized)',
            'swimwear': 'Swimwear (Minimal Coverage)',
            'inuit_parka': 'Inuit Parka (Arctic Insulated)',
            'native_regalia': 'Native Regalia (Indigenous Formal)',
            'cowboy': 'Cowboy (Western Ranch)',
            'hawaiian': 'Hawaiian Shirt (Aloha Casual)',
            'letterman': 'Letterman (Varsity Jacket)',
            'maori_korowai': 'Māori Korowai (Tribal Cloak)',
            'piupiu': 'Piupiu (Māori Flax Skirt)',
            'sulu_lavalava': 'Sulu / Lava-lava (Pacific Wrap)',
            'driza_bone': 'Driza-Bone (Australian Oilskin)',
            'bush_shirt': 'Bush Shirt (Outback Casual)',
            'grass_skirt': 'Grass Skirt (Pacific Ceremonial)',
            'lehenga': 'Lehenga Choli (Indian Bridal)',
            'anarkali': 'Anarkali (Mughal Frock)',
            'dhoti': 'Dhoti (Indian Draped)',
            'turban': 'Turban / Dastar (Sikh Wrapped)',
            'barong_tagalog': 'Barong Tagalog (Philippine Formal)',
            'longyi': 'Longyi (Burmese Wrap)',
            'sinh': 'Sinh (Lao Wrapped Skirt)',
            'baju_melayu': 'Baju Melayu (Malay Traditional)',
            'dirndl': 'Dirndl (Alpine Traditional)',
            'lederhosen': 'Lederhosen (Bavarian Leather)',
            'flamenco': 'Flamenco Dress (Spanish Gown)',
            'foustanella': 'Foustanella (Greek Ceremonial)',
            'sarafan': 'Sarafan (Russian Folk)',
            'bunad': 'Bunad (Norwegian Folk)',
            'vyshyvanka': 'Vyshyvanka (Ukrainian Embroidered)',
            'aran_sweater': 'Aran Sweater (Irish Fisherman)',
            'smock_frock': 'Smock Frock (English Rural)',
            'tweed_suit': 'Tweed Suit (British Country)',
            'morning_tails': 'Morning Tails (Formal Daywear)',
            'mariniere': 'Breton Shirt (French Stripe)',
            'bisht': 'Bisht (Arabian Ceremonial)',
            'kufiya': 'Kufiya / Ghutra (Arabian Scarf)',
            'fez_tarboosh': 'Fez / Tarboosh (North African Hat)',
            'chador': 'Chador (Persian Full-Cover)',
            'jilbab': 'Jilbab (Islamic Overgarment)',
            'huipil': 'Huipil (Mesoamerican Tunic)',
            'poncho': 'Poncho (Andean Wrap)',
            'sombrero_charro': 'Charro Suit (Mexican Equestrian)',
            'pollera': 'Pollera (Panamanian Skirt)',
            'rebozo': 'Rebozo (Mexican Shawl)',
            'ruana': 'Ruana (Colombian Poncho)',
