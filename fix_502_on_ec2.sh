...
if [ "$CONTAINER_NEEDS_RESTART" = true ] || ! docker ps -a | grep -q korra-ai; then
    ...
    SUPABASE_ANON_KEY="${SUPABASE_ANON_KEY:-eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJsc2V0dGFieW1sbHVsc3h0eml3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAwNTY3NjksImV4cCI6MjA5NTYzMjc2OX0.PuMsTbgyRRcCQ04Y7Y9Y75WjRqmzgMP4S2_B4372V_U}"
    SUPABASE_SERVICE_ROLE_KEY="${SUPABASE_SERVICE_ROLE_KEY:-eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJsc2V0dGFieW1sbHVsc3h0eml3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MDA1Njc2OSwiZXhwIjoyMDk1NjMyNzY5fQ.oQz1KDOXuPdP2l35pXQVjry5stoe9_Wp4nzEDwPXX2I}"
    PAYSTACK_PUBLIC_KEY="${PAYSTACK_PUBLIC_KEY:-pk_live_b401fac946e696dad14e6e4bd13d706313215f06}"
