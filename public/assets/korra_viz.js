...
class KorraVisualizer {
    constructor() {
        ...
        this._orbitTarget = new THREE.Vector3(0, 0.4, 0);
    ...
    init(containerId) {
        ...
        this.camera.position.set(0, 0.4, 3.0);
    ...
    parseAndRenderOBJ(text) {
        ...
        this.camera.position.y = size.y * 0.4;
        ...
        this.updateOrbitTarget(new THREE.Vector3(0, size.y * 0.4, 0));
